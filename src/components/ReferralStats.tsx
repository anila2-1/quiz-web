  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-3xl font-extrabold bg-gradient-to-r from-green-600 to-purple-600 dark:from-green-400 dark:to-pink-400 bg-clip-text text-transparent mb-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm truncate"
