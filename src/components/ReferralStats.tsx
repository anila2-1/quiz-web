...
export default function ReferralStats({ count, code }: { count: number; code: string }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white/90 top-6 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200 p-5 transition-all duration-300 hover:shadow-2xl hover:scale-101 relative overflow-hidden"
    >
