...
export default function WalletCard() {
  ...
  return (
    <motion.div
      ...
      className="group bg-white/90 dark:bg-gray-800/90 top-6 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/60 dark:border-gray-700 p-7 transition-all duration-300 hover:shadow-2xl hover:scale-101 relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-pink-400 bg-clip-text text-transparent mb-5">
